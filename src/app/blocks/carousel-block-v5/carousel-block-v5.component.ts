...
@Component({
  selector: 'app-carousel-block-v5',
  templateUrl: './carousel-block-v5.component.html',
  styleUrls: ['./carousel-block-v5.component.css']
})
export class CarouselBlockV5Component {
  @Input() data: any = {};
