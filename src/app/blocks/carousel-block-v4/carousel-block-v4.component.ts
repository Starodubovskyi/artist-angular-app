...
@Component({
  selector: 'app-carousel-block-v4',
  templateUrl: './carousel-block-v4.component.html',
  styleUrls: ['./carousel-block-v4.component.css']
})
export class CarouselBlockV4Component {
  ...
  ngOnInit() {
    ...
    console.log(this.data,'contentItems')
  }
