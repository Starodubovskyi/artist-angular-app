...
@Component({
  selector: 'app-feature-v4-config',
  templateUrl: './feature-v4-config.component.html',
  styleUrls: ['./feature-v4-config.component.css']
})
export class FeatureV4ConfigComponent {
  static config: any = {
    title: 'Feature V4',
    items: [
      {
